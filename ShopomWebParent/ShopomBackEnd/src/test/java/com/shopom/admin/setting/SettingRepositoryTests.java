...
public class SettingRepositoryTests {
	...
	public void testCreateGeneralSettings() {
		Setting siteName = new Setting("SITE_NAME", "shopom", SettingCategory.GENERAL);
		Setting siteLogo = new Setting("SITE_LOGO", "shopom.png", SettingCategory.GENERAL);
		Setting copyright = new Setting("COPYRIGHT", "copyright (c) 2023 shopom Ltd", SettingCategory.GENERAL);
	...
	@Test
	public void testCreateCurrencylSettings() {

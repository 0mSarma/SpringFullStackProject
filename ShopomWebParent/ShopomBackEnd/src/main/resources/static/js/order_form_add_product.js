...
$(document).ready(function() {
	...
	document.getElementById('linkAddProduct').addEventListener('click', function(e) {
...
function getProductInfo(productId, shippingCost) {
	...
	$.get(requestURL, function(productJson){  //here productJSON is the ProductDTO object received from ProductRestController
			...
			<div class="border rounded p-1" id="${rowId}">
				...
				<div class="row">
					<div class="col-1">
						...
						<div><a class="fa-solid fa-trash icon-dark linkRemove" href="" rowNumber="${nextCount}"></a></div>
					</div>
					<div class="col-3">

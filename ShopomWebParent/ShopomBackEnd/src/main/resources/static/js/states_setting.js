...
function deleteState() {
	...
	$.ajax({
		...
		showToastMessage("Error: could not connect")
	});
}
...
function loadStates4Country() {
	...
	$.get(url, function(responseJSON){
		...
		showToastMessage("Error: could not connected to the server")
	});
}
...
function loadCountries4States() {
	...
	$.get(url, function(responseJSON) {
		...
		showToastMessage("All countries have been loaded for country ");
	}).fail(function() {
		showToastMessage("Error: Could not connect")
	});
}

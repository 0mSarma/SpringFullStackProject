...
public class CustomerController {
	...
	public String listByPage(
			@PagingAndSortingParam(listName = "listCustomers", moduleURL = "/customer") PagingAndSortingHelper helper,
	...
	public String deleteCustomer(@PathVariable Integer id, RedirectAttributes ra) {
		try {
			service.delete(id);
			ra.addFlashAttribute("message", "The customer Id " + id + " has been deleted sucessfully");

...
function removeProduct(link){
	...
	$.ajax({
		...
		showErrorModal("Error while remocing   product to shopping cart");
	});
}
...
function showEmptyShoppingCart(){
	$("#sectionTotal").hide();
	$("#sectionEmptyCartMessage").removeClass("d-done");
}

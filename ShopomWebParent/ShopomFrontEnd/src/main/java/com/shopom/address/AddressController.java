...
public class AddressController {
	...
	public String saveAddress(Address address, HttpServletRequest request, RedirectAttributes ra) {
		...
		ra.addFlashAttribute("message", "the address has been saved sucessfully");
	...
	public String editAddress(@PathVariable("id") Integer addressId, RedirectAttributes ra, HttpServletRequest request) {
		Customer customer = getAuthenticatedCustomer(request);
